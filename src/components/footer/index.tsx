export function Footer() {
    return (
        <footer id="contatos" className="w-full flex flex-col justify-center gap-4 h-[700px] lg:h-[302px] bg-[#FBFBFB]">
            <div className="flex flex-col items-center justify-evenly md:justify-center lg:justify-around md:gap-7 lg:gap-0 md:flex-row md:flex-wrap h-full">
                ...
                <div className="w-[305px] flex flex-col gap-4 h-36 justify-between">
                    ...
                    <div className="w-full flex gap-3">
                        <a className="w-40 h-10 flex text-primary bg-white border-primary border items-center justify-center rounded-lg" rel="noopener noreferrer" target="_blank" href="https://www.atlantico.com.br/">Sobre o Instituto</a>
                        <a className="w-40 h-10 flex text-primary bg-white border-primary border items-center justify-center rounded-lg" rel="noopener noreferrer" target="_blank" href="https://github.com/Renchs/sistema-pata-frontend">Avalie o projeto</a>
                    </div>
                </div>
            </div>
