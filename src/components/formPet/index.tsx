        ...
        <form onSubmit={handleSubmit(onSubmit)} className="sm:w-[640px] flex flex-col items-center gap-6">
            ...
            <div className="flex flex-col sm:flex-row w-full gap-4 sm:gap-16 sm:items-start items-center">
                <div className="flex flex-col gap-1">
                    ...
                    <Controller
                        ...
                        render={({ field }) => (
                            <select
                                {...field}
                                className="w-[281px] text-sm h-[35px] border border-primary bg-white py-1 px-2 rounded-lg"
                                id="tamanho"
                                name="tamanho"
                            >
                ...
                <div className="flex flex-col gap-1">
                    ...
                    />
                    {errors.personalidade && (
                        <p className="text-xs w-[280px] text-red-500">{errors.personalidade.message}</p>
                    )}
                </div>
            </div>
            ...
            <div className="flex flex-col gap-1">
                ...
                <textarea
                    {...register("descricao")}
                    className="sm:w-[640px] min-w-[280px] text-sm p-3 h-[120px] border rounded-lg border-primary resize-none"
                    required
                    minLength={5}
                ></textarea>
                {errors.descricao && (
                    <p className="text-xs w-[280px] text-red-500">{errors.descricao.message}</p>
                )}
            </div>
