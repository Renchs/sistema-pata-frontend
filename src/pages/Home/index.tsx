    ...
    return (
        <section className="w-full min-h-screen justify-evenly bg-white items-center flex flex-col gap-9">
            <div className="flex flex-col-reverse md:flex-row w-full justify-center md:justify-around h-[600px] items-center">
                ...
                <img className="w-80 lg:w-auto" src="/src/assets/images/homeImg.png" alt="" />
            </div>
            <section className="w-[310px] md:w-[750px] xl:w-[1224px] lg:h-[448px] text-center md:text-start items-center justify-around flex flex-col">
                ...
                <div className="flex flex-col h-[1100px] md:h-[800px] gap-16 lg:gap-0 md:flex-row md:flex-wrap items-center justify-center">
                    <CardPassoHome numPassos={1} img="/src/assets/images/groupAdd.png" text="Crie o seu perfil em alguns minutos." />
                    <img className="hidden xl:block" src="/src/assets/svgs/Right.svg" alt="" />
                    ...
                    <img className="hidden xl:block" src="/src/assets/svgs/Left.svg" alt="" />
                    <CardPassoHome numPassos={3} img="/src/assets/images/group.png" text="Adote o seu Pet" />
                </div>
            </section>

            <section className="items-center w-[350px] md:w-full text-center lg:text-start flex flex-col gap-12">
                <h2 className="text-2xl font-medium">A adoção traz <span className="text-primary">benefícios para todos!</span></h2>

                <div className="md:w-[750px] lg:w-[1069px] flex justify-center flex-wrap gap-[89px]">
            ...
            <section className="w-[350px] md:w-[700px] lg:w-[1168px] h-[800px] md:h-[485px] flex">
                <div className="flex flex-col items-center md:flex-row gap-4 font-medium">
                    <img className="w-80 lg:w-full" src="/src/assets/images/adoptionIlustration.png" alt="" />
                    <div className="w-[full] flex flex-col items-center text-center md:text-start md:items-start justify-center gap-8">
